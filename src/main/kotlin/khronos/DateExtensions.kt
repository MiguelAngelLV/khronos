...
fun Date.with(year: Int = -1, month: Int = -1, day: Int = -1, hour: Int = -1, minute: Int = -1, second: Int = -1, dayOfWeek : Int = -1, millisecond: Int = -1): Date {
    calendar.time = this
...
val Date.endOfDay: Date
    get() = with(hour = 23, minute = 59, second = 59, millisecond = 99)
